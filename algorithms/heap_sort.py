...
def heap_sort(arr, time_limit=None):
    comparisons = 0
    ...
    for i in range(n // 2 - 1, -1, -1):
        if heapify(arr, n, i):
            logger.info("Tempo limite atingido, interrompendo Heap Sort")
...
if __name__ == "__main__":
    ...
    for case_name, test_array in test_cases:
        ...
        sorted_array, comparisons = heap_sort(test_array.copy(), time_limit=1)
