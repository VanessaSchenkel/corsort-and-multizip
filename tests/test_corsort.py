...
logger.add("logs/corsort_test.log")
...
corsort_results, mean_classification_error, std_classification_error, total_comparison_time = evaluate_algorithm(corsort, "Corsort", test_cases)
